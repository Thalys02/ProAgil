    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(UserDto userDto)
        {
            ...
            catch (Exception ex)
            {
                ...
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"Banco de Dados Falhou, By UserController{ex.Message}");
            }
        }
        [HttpPost("Login")]
        [AllowAnonymous]
        ...
        private async Task<string> GenerateJWToken(User user)
        {
            ...
            {
                //adiciona os papeis do usuario nas claims;
                //Exemplo usuario é administrador, palestrante....
